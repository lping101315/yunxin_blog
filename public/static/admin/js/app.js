...
var App = function() {
    ...
    var uiHandleTheme = function() {
        ...
        jQuery('[data-toggle="theme"]').on('click', function(){
            ...
            Yxin.loading();
            jQuery.get(yxin.theme_url, {theme: $theme}, function (res) {
                Yxin.loading('hide');
                if (res.code) {
    ...
    var uiHelperCkeditor = function(){
        ...
        jQuery('.js-ckeditor').each(function () {
            ...
            var editor    = CKEDITOR.replace(editor_id, {
                filebrowserImageUploadUrl: yxin.ckeditor_img_upload_url,
                image_previewText: ' ',
                ...
                callbacks: {
                    onImageUpload: function(files) {
                        ...
                        $.each(files, function () {
                            ...
                            $.ajax({
                                url : yxin.image_upload_url,//后台文件上传接口
                                type : 'POST',
                                data : formData,
                                cache: false,
                                processData : false,
