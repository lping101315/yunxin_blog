...
$.fn.extend({
    animateCss: function(a, b) {
        ...
        return this.addClass("animated " + a).one(c,
            function() {
...
var parsePhotos = function() {
        $.each($(".album-photos figure"),
            function(a, b) {
                var c = new Image;
                "1" === LocalConst.LAZY_LOAD ? c.src = $(b).find("img").attr("data-src") : c.src = $(b).find("img").attr("src"),
                    c.onload = function() {
    ...
    searchInput = function() {
        var a = !1;
        $("#search_input").on("compositionstart",
            function() {
                a = !0
            }),
            $("#search_input").on("compositionend",
                function() {
                    a = !1
                });
        var b = null,
            ...
            function() {
                setTimeout(function() {
                        a || (null !== c && clearTimeout(c), c = setTimeout(function() {
                                ...
                                if ("" !== a.trim()) {
                                    $("#spin-search").addClass("show inline"),
                                        $("#icon-search").addClass("hide"),
                                    null !== b && (b.abort(), b = null),
                                        b = $.getJSON("?action=ajax_search&content=" + a,
                                            function(a) {
                                                $("#search_tips_drop").text(""),
                                                    $("#search_tips_drop").removeClass("hide"),
                                                    $(a.results).appendTo("#search_tips_drop"),
                                                    $("#spin-search").removeClass("show inline"),
                                                    $("#icon-search").removeClass("hide"),
                                                    b = null
                                            })
                                } else $("#search_tips_drop").text(""),
                                    $("#search_tips_drop").addClass("hide"); - 1 != $("#search_input").val().indexOf("自杀") && $.message({
...
var initTheme = function() {
    ...
    a.indexOf("Safari") > -1 && a.indexOf("Chrome") < 1 && $("#left_footer").addClass("hide"),
        $(document).on("click", "[ui-toggle-class]",
            function(a) {
                a.preventDefault();
                var b = $(a.target);
    ...
    var b;
    $(document).on("click", "[ui-nav] a,[ui-nav-fold] a",
        function(a) {
            ...
            if (c.parent().siblings(".active").toggleClass("active"), c.next().is("ul") && c.parent().toggleClass("active") && a.preventDefault(), $(".app-aside-fix").length > 0 && $(window).width() > 768) {
                var d, c = $(a.target),
                    e = $(window).height();
                c.is("a") && c.next().is(".child-nav") && (b = c.parent().parent()),
                $(".app-aside-folded").length && (d = b.position().top, d + b.height() >= e && b.css("bottom", "50px"), d + 150 > e && b.css("bottom", e - d - 50).css("top", "auto")),
                $(".app-aside-dock").length && (120 + b.height() >= e ? b.height(e - 120) : b.css("height", "auto"))
            }
            c.next().is("ul") || $(window).width() < 768 && $(".off-screen").removeClass("show off-screen")
        });
    var c = !0;
    $(document).on("mouseenter", "[ui-nav] a",
        function(a) {
            if ($(document).on("mouseenter", ".app-aside>ul.nav",
                function(a) {
                    c = !0
                }), $(document).on("mouseleave", ".app-aside>ul.nav",
                function(a) {
                    c = !1
                }), b && b.trigger("mouseleave.nav"), $("> .nav", $(".app-aside")).remove(), $(".app-aside-fix").length && !($(window).width() < 768)) {
                var d, e = $(a.target),
                    f = $(window).height(); ! e.is("a") && (e = e.closest("a")),
                e.next().is("ul") && (b = e.next(), $(".app-aside-folded").length && (e.parent().addClass("active"), b.appendTo(".app-aside"), d = e.parent().position().top, b.css("top", d), b.attr("ui-nav-fold", ""), d + b.height() > f && b.css("bottom", "50px"), d + 150 > f && b.css("bottom", f - d - 50).css("top", "auto"), b.on("mouseleave.nav",
                    function(a) {
        ...
        $(document).on("mouseleave", ".app-aside:not(.app-aside-dock)",
            function(a) {
                c = !1,
                b && b.trigger("mouseleave.nav"),
    ...
    Module_Timer: function(a) {
        function b(a) {
            if (0 === u && (u = 60), 60 === u) try {
                i--;
                var e = !0;
                0 === i && (i = 59, h--, h <= 0 && (h = 59, g--, g <= 0 ? (window.cancelAnimationFrame(j), e = !1) : (o.text(d(g)), p.data("easyPieChart").update(c(g, 24)))), e && (q.text(d(h)), r.data("easyPieChart").update(c(h, 60)))),
                e || (i = 0),
                    s.text(d(i)),
                    t.data("easyPieChart").update(c(i, 60)),
        ...
        e = a.leaveTime,
            ...
            r.data("easyPieChart").update(c(h, 60)),
            t.data("easyPieChart").update(c(i, 60)),
            p.data("easyPieChart").update(c(g, 24)),
            n.data("easyPieChart").update(c(f, 10)),
            m.text(d(f)),
            o.text(d(g)),
            q.text(d(h)),
            s.text(d(i)),
    ...
    function(a) {
        ...
        a(function() {
            initTheme(),
                ...
                l(),
                q(),
                a(".skPlayer-list-switch").bind("click",
                    function() {
                        player.toggleList()
                    }),''
        ...
        var b = function() {
                feather.replace({
                    ...
                    parsePhotos(),
                    e(),
                    a(".off-screen-toggle").click(function() {
                        a("#aside").toggleClass("off-screen")
                    }),
                    a('[data-toggle="tooltip"]').tooltip(),
                    LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_ROOT ? (m(), a(function() {
                    ...
                    })) : LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_CHANGYAN && n(),
                    LocalConst.IS_PAJX_COMMENT ? p() : r(),
                    o(),
                "function" == typeof registCommentEvent && registCommentEvent(),
                LocalConst.THEME_HEADER_FIX && t(),
                LocalConst.THEME_TOC && j(),
                    h(),
                    i(),
                    k(),
                    f(),
                    window.Page.seFancyBox(),
                    a("#post-content").find("table").wrap("<div class='table-responsive box-shadow-wrap-lg'></div>"),
                LocalConst.THEME_HIGHLIGHT_CODE && s(),
                    d(),
                    c()
            },
            c = function() {
                a(".plus-font-size").click(function() {
                    ...
                    b.slice( - 2);
                    c <= 14 ? c += 2 : c -= 2,
                        a("#post-content").css("font-size", c + "px")
                })
            },
            d = function() {
            ...
            f = function() {
                ...
                a("#imageInsertOk").bind("click",
                    function() {
                        var c = a("input[ name='imageInsertModal']").val();
                        c = '<img src="' + c + '">',
                            g(b, c, "#imageInsertModal")
                    }),
                    a("#videoInsertOk").bind("click",
                        function() {
                            var c = a("input[ name='videoInsertModal']").val();
                            c = '<video src="' + c + '"></video>',
                                g(b, c, "#videoInsertModal")
                        }),
                    a("#musicInsertOk").bind("click",
                        function() {
            ...
            h = function() {
                a("#post-content video, #comments video").each(function() {
                    a(this).hasClass("dplayer-video") || (void 0 !== a(this).attr("controls") && a(this).removeAttr("controls"), void 0 === a(this).attr("preload") && a(this).attr("preload", "preload"), a(this).wrap('<div class="kyt-player"></div>'), a(this).parent().append('<div class="play-button"></div>').css("height", .6 * a(this).width()), a(this).bind("click",
                        function() {
                    ...
                    a("#post-content,#comments").delegate(".play-button", "click",
                        function(b) {
            ...
            i = function() {
                a(".weixinAudio").each(function() {
                    ...
                    "" !== f ? a.ajax({
                        ...
                        success: function(b) {
                            var f = a.parseJSON(b);
                            c.children("source").attr("src", f.url),
                                c.load(),
                                d.text(f.name),
                                e.text(f.author)
                        }
            ...
            j = function() {
                if (a(window).width() < 992) {
                    ...
                    if (c.length > 0) {
                        ...
                        c.css("top", Number(LocalConst.OFF_SCROLL_HEIGHT)),
            ...
            n = function() {
                window.changyan = void 0,
                    window.cyan = void 0,
                1 == a("#SOHUCS").length && (a("#spin_comment_changyan").addClass("show inline"), a.getScript("https://changyan.sohu.com/upload/changyan.js",
                    function() {
            ...
            p = function() {
                function b() {
                    a(f + " a").click(function() {
                        j = a(this).parent().parent().parent().parent().attr("id"),
                            a(g).focus()
                    }),
                ...
                var d = a(window.opera ? "CSS1Compat" == document.compatMode ? "html": "body": "html,body"),
                    ...
                    j = "";
                b(),
                    a("#comment_form").submit(function() {
                            ...
                            a.ajax({
                                ...
                                success: function(k) {
                                    a(h).removeClass("active"),
                                        a("#spin").removeClass("show inline");
                                    try {
                                        if (!a(".comment-list", k).length) return console.log(a("div", k)),
                                        "undefined" != typeof content && "" != content || (content = LocalConst.COMMENT_CONTENT_LEGAL_INFO),
                                            a.message({
                                                title: LocalConst.COMMENT_TITLE,
                                                message: content,
                                                type: "error"
                                        ...
                                        a(".page-navigator .prev").length && "" == j && (i = ""),
                                            c("#success"),
                                            j ? (k = a("#comment-" + i, k).hide(), a("#" + j).find(".comment-children").length <= 0 && a("#" + j).append("<div class='comment-children list-unstyled m-l-xxl'><ol class='comment-list'></ol></div>"), i && a("#" + j + " .comment-children .comment-list").prepend(k), j = "") : (k = a("#comment-" + i, k).hide(), a(".comment-list").length || a("#comments").prepend('<h4 class="comments-title m-t-lg m-b special"> 0 条评论</h4><ol class="comment-list"></ol>'), a(".comment-list").prepend(k)),
                                            a("#comment-" + i).fadeIn();
                                        var l;
                                        a(e).length && (l = parseInt(a(e).text().match(/\d+/)), a(e).html(a(e).html().replace(l, l + 1))),
                                            TypechoComment.cancelReply(),
                                            a(g).val(""),
                                            a(f + " a, #cancel-comment-reply-link").unbind("click"),
                                            b(),
                                            a(h).attr("disabled", !1).fadeTo("slow", 1),
                                            i ? d.animate({
            ...
            q = function() {
                ...
                a("form.protected").submit(function() {
                    return a.ajax({
                        ...
                        success: function(b) {
                            try {
                                ...
                                a("#post-content").html(c),
                                    a("#comments").html(d),
                                    a("#small_widgets h1").html(e)
                            } catch(a) {
                                window.location.reload()
                            }
                        }
                    ...
                    a("#Login_form").submit(function() {
                        if (a(this).hasClass("banLogin")) return location.reload(),
                            !1;
            ...
            t = function() {
                a("#comments,#small_widgets").delegate("a[href^=\\#][href!=\\#]", "click",
                    function() {
        ...
        window.Page = {
            seFancyBox: function() {
                a.fancybox.defaults.buttons = ["zoom", "download", "thumbs", "close"],
                    a("#post-content img, #comments img,.streamline img").each(function() {
                        var b = a(this);
                        ...
                        if (void 0 !== b.attr("max") && b.wrap('<div class="max-img"></div>'), "undefined" === e && d.size() < 1) {
                            var g;
                            g = void 0 === this.getAttribute("data-original") || "" === this.getAttribute("data-original") || null === this.getAttribute("data-original") ? this.getAttribute("src") : this.getAttribute("data-original"),
                                g = g.replace(/(.*?)[!|\?]\/.*/, "$1");
                            var h = b.attr("class"),
                                i = "";
                            ...
                            j += i,
                                "undefined" !== f ? b.prop("outerHTML", '<a class="light-link img-blur" data-fancybox="gallery" style="background-image: url(' + g + ')" no-pjax data-type="image" data-caption="' + c + '" href="' + g + '">' + j + "</a>") : b.prop("outerHTML", '<a class="light-link" data-fancybox="gallery" no-pjax data-type="image" data-caption="' + c + '" href="' + g + '">' + j + "</a>")
                        }
                    })
            },
            ...
            reInitDPlayer: function() {
                if (! ("undefined" == typeof dPlayerOptions || "undefined" == typeof dPlayers || a(".dplayer").length <= 0)) for (var b = dPlayerOptions.length,
                                                                                                                                      c = 0; c < b; c++) dPlayers[c] = new DPlayer({
            ...
            doPJAXCompleteAction: function() {
                a("#Login_form").hasClass("banLogin") || (a("#Login_form").addClass("banLogin"), a("#navbar-login-user").attr("disabled", "disabled"), a("#navbar-login-password").attr("disabled", "disabled")),
                    this.reInitAPlayer(),
                    this.reInitDPlayer(),
                    b()
            },
